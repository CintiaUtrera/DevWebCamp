<main class="paquetes">
    ...
    <div class="paquetes__grid">
        <div class="paquete">
            <h3 class="paqute_nombre">Pase Gratis</h3>
        ...
        <div class="paquete">
            <h3 class="paqute_nombre">Pase Presencial</h3>
            <ul class="paquete__lista">
                ...
                <p class="paquete_precio">$2000</p>
            </ul>
        </div>

        <div class="paquete">
            <h3 class="paqute_nombre">Pase Virtual</h3>
            <ul class="paquete__lista">
                <li class="paquete_elemento">Acceso Virtual a DevWebCamp</li>
                <li class="paquete_elemento">Pase por 2 días</li>
                <li class="paquete_elemento">Acceso a talleres y conferencias</li>
